 ...
 */
vertex VertexDesc triangleVertexShader(
                                 constant TriangleVertex* vertexAttribute0   [[buffer(0)]], // 顶点属性vertexAttribute0是个数组 通过vid来索引
 ...
 */
fragment float4 triangleFragmentShader(VertexDesc                             vert                [[stage_in]]
